...
fun DetalleSesionScreen(
    ...
    //
    // uso remember para no recalcularlo en cada recomposicion
    // si no cambia la lista de ejercicios de la sesion.
        ...
        BoxWithConstraints(
            ...
            LazyColumn(
                ...
                itemsIndexed(gruposDeEjercicios) { indexGrupo, grupo ->
                    ...
                    if (isLandscape) {
                        // en horizontal coloco los ejercicios del grupo en una fila.
                        //
                        // uso height(intrinsicsize.min) para que la fila tome la altura
                        // del elemento mas alto del grupo.
                        //
                        // luego cada box hija usa fillmaxheight para que todas las cards
                        // igualen esa altura y queden alineadas arriba y abajo.
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                            ...
                            for (ejercicio in grupo) {
                                ...
                                // uso fillmaxheight para que todas las tarjetas del grupo
                                // tengan la misma altura que la mas alta.
                                Box(
                                    modifier = Modifier
                                        .weight(1f)
                                        .fillMaxHeight()
